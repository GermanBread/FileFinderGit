...
alias compile="dotnet publish -p:PublishSingleFile=true -p:PublishTrimmed=true --configuration Release -o build --self-contained --nologo -p:IncludeNativeLibrariesForSelfExtract=true"
